...
始めとして、有償無償問わず様々開発されている。\comment{関連ソフトの「名称・作者・論文」などの一覧表をどこかにのせておきたい。}
...
近似計算が必要となる。したがって、スコア関数に関しても様々な提案がなされている。\comment{これに関してもChangが示しているようなForce field, Empirical, Knowledge basedの分類を表で示す。表にまとめることが大切。}
